...
_ref: [the-super-tiny-compiler](https://github.com/jamiebuilds/the-super-tiny-compiler)_
...
```js showLineNumbers title="THE TOKENIZER!!!" caption="tokenizer"
...
```js showLineNumbers title="THE PARSER!!!" caption="parser"
...
```js showLineNumbers title="THE TRAVERSER!!!" caption="traverser"
/**
...
```js showLineNumbers title="THE TRANSFORMER!!!" caption="transformer"
/**
...
```js showLineNumbers title=" THE CODE GENERATOR!!!" caption="codeGenerator"
