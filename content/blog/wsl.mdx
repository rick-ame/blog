...
_If you are using [Clash Verge](https://github.com/clash-verge-rev/clash-verge-rev) for proxy, you can use the TUN mode, and set its [stack](https://wiki.metacubex.one/en/config/inbound/tun/#stack) to "Mixed"._
